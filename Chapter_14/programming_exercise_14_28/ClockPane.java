...
public class ClockPane extends Pane {
	...
	public void setHourHandVisible(boolean set) {
		this.hourHandVisible = set;
	}
	...
	public void setSecondHandVisible(boolean set) {
		this.secondHandVisible = set;
	}
	...
	public void setMinuteHandVisible(boolean set) {
		this.minuteHandVisible = set;
	}
	...
	private void paintClock() {
		...
		else if(!this.minuteHandVisible)
			getChildren().addAll(circle, t1, t2, t3, t4, sLine, hLine);
		else if(!this.hourHandVisible)
